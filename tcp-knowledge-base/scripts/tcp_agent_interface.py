...
class TCPAgentInterface:
    ...
    def load_tcp_registry(self):
        ...
        sample_commands = {
            ...
            "ls": {
                "risk": "SAFE",
                "caps": ["file_ops", "search"],
                "desc": "List directory contents safely",
            },
            "cat": {
                "risk": "SAFE",
                "caps": ["file_ops", "data"],
            ...
            "find": {
                "risk": "LOW_RISK",
                "caps": ["search", "file_ops"],
                "desc": "Find files and directories",
            },
            "ag": {
                "risk": "SAFE",
                "caps": ["search", "data"],
                "desc": "Fast code searching",
            },
            "rg": {
                "risk": "SAFE",
                "caps": ["search", "data"],
            ...
            "nc": {
                "risk": "HIGH_RISK",
                "caps": ["network"],
                "desc": "Arbitrary network connections",
            },
            "nmap": {
                "risk": "HIGH_RISK",
                "caps": ["network", "security"],
            ...
            "kill": {
                "risk": "HIGH_RISK",
                "caps": ["process"],
                "desc": "Terminate processes",
            },
            "nice": {
                "risk": "MEDIUM_RISK",
                "caps": ["process"],
                "desc": "Adjust process priority",
            },
            # Container operations
            "docker": {
                "risk": "MEDIUM_RISK",
                "caps": ["container", "process"],
                "desc": "Container management",
            },
            "docker-compose": {
                "risk": "MEDIUM_RISK",
                "caps": ["container"],
                "desc": "Multi-container apps",
            },
            "kubectl": {
                "risk": "MEDIUM_RISK",
                "caps": ["container", "network"],
                "desc": "Kubernetes control",
            },
            # Security tools
            "sudo": {
                "risk": "CRITICAL",
                "caps": ["security", "process"],
                "desc": "Execute as superuser",
            },
            "chmod": {
                "risk": "HIGH_RISK",
                "caps": ["security", "file_ops"],
    ...
    def agent_query(self, task: str) -> Dict:
        ...
        if any(
            word in task_lower for word in ["download", "upload", "network", "connect"]
        ):
    ...
    def show_query_result(self, result: Dict):
        ...
        print(
            f"   📍 Required capabilities: {', '.join(result['required_capabilities'])}"
        )
