...
Concerns & root needed? <50 words"""
        ...
        if analysis:
            ...
            with self.lock:
                ...
                if self.completed % 50 == 0:
                    print(f"Progress: {self.completed} analyzed (Anthropic: {self.analysis_sources['anthropic']}, Ollama: {self.analysis_sources['ollama']})")
    ...
    def hybrid_burst_analyze(self):
        ...
        print(f"📊 Distribution: {len(anthropic_commands)} Anthropic, {len(ollama_commands)} Ollama")
