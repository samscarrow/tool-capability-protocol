    ...
    for cmd, description in test_commands:
        ...
        try:
            ...
            if descriptor:
                ...
                analysis = server.analyzer.analyze_command_text(
                    cmd, f"Unknown command: {description}"
                )

                print(f'   Risk Level: {analysis["risk_level"]}')
                print(
                    f'   Security Flags: {", ".join(analysis["flags"]) if analysis["flags"] else "None"}'
                )
            ...
            results.append(
                {"command": cmd, "description": description, "error": str(e)}
            )
