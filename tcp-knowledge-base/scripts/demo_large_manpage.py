    ...
    for cmd in complex_commands:
        ...
        try:
            ...
            if man_content:
                ...
                tcp_desc = analyzer.generate_tcp_descriptor(
                ...
                print(
                    f"  📊 {original_size:,} → {tcp_size} bytes = {compression:.0f}:1 compression"
                )
                print(
                    f'  ⚡ Flags: {", ".join(analysis["flags"][:5]) if analysis["flags"] else "None"}'
                )
